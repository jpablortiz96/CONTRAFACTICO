...
export function getEnterpriseReadinessCore(): EnterpriseReadiness {
  return {
    ...
    readiness_score: 82,
    production_gaps: [
      "Copilot Studio connection pending",
      "Azure Container Apps deployment pending",
      "real tenant connector configuration pending",
      "production telemetry backend pending",
      "enterprise key vault wiring pending",
    ],
    ...
    required_for_real_tenant: [
      ...
      "Copilot Studio connection with Entra OAuth",
    ...
    next_steps: [
      ...
      "Configure a tenant Entra application and Copilot Studio connection.",
